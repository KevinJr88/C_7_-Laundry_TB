...
public class WorkOrderDAO {
    ...
    public void insertWorkOrder(WorkOrder wo){
        ...
        String sql = "INSERT INTO WorkOrder(id_transaksi, tanggal_masuk, tanggal_selesai, bobot, customer, karyawan, layanan) values ('"
              + wo.getId_transaksi() + "','" + wo.getTanggal_masuk() + "','" + wo.getTanggal_selesai() + "','" 
              + wo.getBobot() + "','" + wo.getCustomer().getId_customer() + "','" + wo.getKaryawan().getId_karyawan() + "','"
              + wo.getLayanan() + "')";
            ...
            if(rs!=null){
                while(rs.next()){
                    ...
                    WorkOrder wo = new WorkOrder(Integer.parseInt(rs.getString("wo.id_transaksi")), 
                        ...
                        Integer.parseInt(rs.getString("wo.bobot")), c, e, s);
